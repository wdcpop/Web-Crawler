...
class CHINAISA(CrawlerAbstract):
    ...
    title = u'中钢协 - 市场分析'
    start_urls = [
        'http://www.chinaisa.org.cn/gxportal/DispatchAction.do?efFormEname=ECTM40&key=CmlaZQ9kVTQLalViVDNQMQZiVTZVMVtsBTYHMlMxAjQHFA1CDRYCMAobAUYEEwVl',
    ]
    url_links_selector = '.subpage_inf_width a'
    content_selector = dict(
        title='.subpage_inftitle_1',
        content='.subpage_inftitle_1',
        date_area='.subpage_inftitle_1time'
    )
